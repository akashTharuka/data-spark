...
const Rating = () => {
    return (
        <div className="rating d-flex flex-row-reverse justify-content-center position-relative p-0 overflow-hidden">
            <input type="radio" name="rating" id="rating-5" className='d-none' />
            <label htmlFor="rating-5"></label>

            <input type="radio" name="rating" id="rating-4" className='d-none' />
            <label htmlFor="rating-4"></label>

            <input type="radio" name="rating" id="rating-3" className='d-none' />
            <label htmlFor="rating-3"></label>

            <input type="radio" name="rating" id="rating-2" className='d-none' />
            <label htmlFor="rating-2"></label>

            <input type="radio" name="rating" id="rating-1" className='d-none' />
